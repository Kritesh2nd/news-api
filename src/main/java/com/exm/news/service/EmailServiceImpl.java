...
public class EmailServiceImpl{
    ...
    public String sendSimpleMail(String receiver) {
        ...
        try {
            ...
            mailMessage.setText("You are accepted as editor for News Insight");
            mailMessage.setSubject("Acceptance Result");
    ...
    private String getSender(){
        ...
        System.out.println("Sender email: "+userAuth.getEmail());
